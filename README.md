...
The analysis pipeline consists of 3 separate modules designed to be run in order:
...
If you are new to the Photometry Analysis Tool, please see our guide here.
